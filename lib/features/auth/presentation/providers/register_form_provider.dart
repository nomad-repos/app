...
class RegisterFormNotifier extends StateNotifier<RegisterFormState> {
  ...
  onNameChange(String value) {
    ...
    state = state.copyWith(
        ...
        isValid: Formz.validate(
            [newName, state.surname, state.email, state.password]));
  }
  ...
  onSurnameChange(String value) {
    ...
    state = state.copyWith(
        surname: newSurname,
        isValid: Formz.validate(
            [state.name, newSurname, state.email, state.password]));
  }
  ...
  onEmailChange(String value) {
    ...
    state = state.copyWith(
        email: newEmail,
        isValid: Formz.validate(
            [state.name, state.surname, newEmail, state.password]));
  }
  ...
  onPasswordChanged(String value) {
    ...
    state = state.copyWith(
        ...
        isValid: Formz.validate(
            [state.name, state.surname, state.email, newPassword]));
  }
  ...
  onFormSubmit(BuildContext context) async {
    ...
    await registerUserCallback(state.name.value, state.surname.value,
